...
import {  reduce, scan,take,tap,first, takeWhile , map, takeUntil, skip, distinct, distinctUntilChanged, distinctUntilKeyChanged} from 'rxjs/operators'; 
...
//distinctUntilKeyChange estara pendiente de esa llave que se le envie para validar si es igual al anterior, si es diferente lo emite
...
from(personajes).pipe(
    ...
    distinctUntilKeyChanged('nombre')// valida la propiedad que le enviamos del objeto
).subscribe(console.log)
